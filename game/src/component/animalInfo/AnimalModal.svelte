            ...
            <div class="row align-items-start  container-fluid">
                ...
                <div class="col">
                    <div class="animalName">
                        {info.name}<button class="openModalBtn" on:click={()=>isModalOpen=false}><i class="bi-zoom-out"></i></button>
                    </div>
...
<style>
    ...
    .animalModal::-webkit-scrollbar { display: none; }
	.animalModal {
